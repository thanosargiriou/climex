...
for filename in glob.glob("*_rr.csv"):
    ...
    df_output_out_of_base = pd.DataFrame({"Date": dates, "R95p (% of days)": r_lst_final})
    ...
    df_output_base_period = pd.DataFrame({"Date": base_year_lst, "R95p (% of days)": index_base_list})
